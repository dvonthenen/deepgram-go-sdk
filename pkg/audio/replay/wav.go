...
func NewWav(opts ReplayOptions) (*WavClient, error) {
...
func (c *WavClient) Read() ([]byte, error) {
...
func (c *WavClient) Stream(w io.Writer) error {
	for {
		select {
		case <-c.stopChan:
